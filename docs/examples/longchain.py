"""This is John Gibson's translation of longchain.sco to python for testing.

The only difference is that it is imports from the oort library instead,
but the end result is exactly the same.  Refer to longchain_oort.py for
a version of this script using Oort features."""
